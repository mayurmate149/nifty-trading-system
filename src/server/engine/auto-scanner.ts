...
export interface ScanLeg {
  ...
  /** Per-share Greeks from the chain (when available). */
  gamma?: number;
  theta?: number;
  vega?: number;
  oi: number;
  ...
  for (const dist of [100, 150, 200, 250, 300]) {
    ...
    results.push({
      ...
      legs: [{
        ...
        iv: row.pe.iv, delta,
        gamma: row.pe.greeks?.gamma, theta: row.pe.greeks?.theta, vega: row.pe.greeks?.vega,
        oi: row.pe.oi,
  ...
  for (const dist of [100, 150, 200, 250, 300]) {
    ...
    results.push({
      ...
      legs: [{
        ...
        iv: row.ce.iv, delta,
        gamma: row.ce.greeks?.gamma, theta: row.ce.greeks?.theta, vega: row.ce.greeks?.vega,
        oi: row.ce.oi,
      ...
      results.push({
        ...
        legs: [
          { action: "SELL", optionType: "PE", strike: sellStrike, premium: r2(sell.pe.ltp),
            iv: sell.pe.iv, delta: sellDelta,
            gamma: sell.pe.greeks?.gamma, theta: sell.pe.greeks?.theta, vega: sell.pe.greeks?.vega,
            oi: sell.pe.oi,
          ...
          { action: "BUY", optionType: "PE", strike: buyStrike, premium: r2(buy.pe.ltp),
            iv: buy.pe.iv, delta: Math.abs(buy.pe.greeks?.delta ?? 0),
            gamma: buy.pe.greeks?.gamma, theta: buy.pe.greeks?.theta, vega: buy.pe.greeks?.vega,
            oi: buy.pe.oi,
      ...
      results.push({
        ...
        legs: [
          { action: "SELL", optionType: "CE", strike: sellStrike, premium: r2(sell.ce.ltp),
            iv: sell.ce.iv, delta: sellDelta,
            gamma: sell.ce.greeks?.gamma, theta: sell.ce.greeks?.theta, vega: sell.ce.greeks?.vega,
            oi: sell.ce.oi,
          ...
          { action: "BUY", optionType: "CE", strike: buyStrike, premium: r2(buy.ce.ltp),
            iv: buy.ce.iv, delta: Math.abs(buy.ce.greeks?.delta ?? 0),
            gamma: buy.ce.greeks?.gamma, theta: buy.ce.greeks?.theta, vega: buy.ce.greeks?.vega,
            oi: buy.ce.oi,
    ...
    results.push({
      ...
      legs: [
        { action: "SELL", optionType: "CE", strike: sellCall, premium: r2(sc.ce.ltp),
          iv: sc.ce.iv, delta: callDelta,
          gamma: sc.ce.greeks?.gamma, theta: sc.ce.greeks?.theta, vega: sc.ce.greeks?.vega,
          oi: sc.ce.oi,
        ...
        { action: "BUY", optionType: "CE", strike: buyCall, premium: r2(bc.ce.ltp),
          iv: bc.ce.iv, delta: Math.abs(bc.ce.greeks?.delta ?? 0),
          gamma: bc.ce.greeks?.gamma, theta: bc.ce.greeks?.theta, vega: bc.ce.greeks?.vega,
          oi: bc.ce.oi,
        ...
        { action: "SELL", optionType: "PE", strike: sellPut, premium: r2(sp.pe.ltp),
          iv: sp.pe.iv, delta: putDelta,
          gamma: sp.pe.greeks?.gamma, theta: sp.pe.greeks?.theta, vega: sp.pe.greeks?.vega,
          oi: sp.pe.oi,
        ...
        { action: "BUY", optionType: "PE", strike: buyPut, premium: r2(bp.pe.ltp),
          iv: bp.pe.iv, delta: Math.abs(bp.pe.greeks?.delta ?? 0),
          gamma: bp.pe.greeks?.gamma, theta: bp.pe.greeks?.theta, vega: bp.pe.greeks?.vega,
          oi: bp.pe.oi,
